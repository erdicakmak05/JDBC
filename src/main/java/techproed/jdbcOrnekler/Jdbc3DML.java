...
public class Jdbc3DML {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sys?serverTimezone=UTC", "root", "0917.1238");
...
//      System.out.println(count + " "+"satır eklendi");
        ...
        st.executeBatch(); // vrileri bir seferde database e yollar
